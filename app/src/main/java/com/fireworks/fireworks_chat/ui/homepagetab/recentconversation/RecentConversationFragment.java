...
import com.fireworks.fireworks_chat.ui.groupchatroom.GroupChatRoomActivity;
import com.fireworks.fireworks_chat.ui.privatechatcreation.PrivateChatCreationActivity;
...
/**
 * Created by zlifhaikal on 18/8/19.
 */
public class RecentConversationFragment extends Fragment implements RecentConversationPresenter.View, SwipeRefreshLayout.OnRefreshListener {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        presenter = new RecentConversationPresenter(this, App.getInstance().getComponent().getChatRoomRepository());
    }
