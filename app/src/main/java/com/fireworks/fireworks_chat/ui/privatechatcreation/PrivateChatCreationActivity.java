...
import com.fireworks.fireworks_chat.ui.groupchatcreation.GroupChatCreationActivity;
...
public class PrivateChatCreationActivity extends AppCompatActivity implements PrivateChatCreationPresenter.View {
    ...
    private User stranger = new User(STRANGER_CHAT_ID, "Add Contact", "");
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        presenter = new PrivateChatCreationPresenter(this, App.getInstance().getComponent().getUserRepository());
    }
