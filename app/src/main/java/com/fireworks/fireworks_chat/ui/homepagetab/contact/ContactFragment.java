...
import com.fireworks.fireworks_chat.ui.privatechatcreation.ContactDialogProfileFragment;
...
public class ContactFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener, ContactPresenter.View {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        presenter = new ContactPresenter(this, App.getInstance().getComponent().getUserRepository());
    }
