...
import com.fireworks.fireworks_chat.ui.groupchatcreation.groupinfo.GroupInfoFragment;
...
public class GroupChatCreationActivity extends AppCompatActivity implements GroupChatCreationPresenter.View {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        presenter = new GroupChatCreationPresenter(this, App.getInstance().getComponent().getUserRepository());
