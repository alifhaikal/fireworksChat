...
import com.fireworks.fireworks_chat.ui.addmember.AddGroupMemberActivity;
...
public class GroupDetailActivity extends AppCompatActivity implements GroupDetailPresenter.View {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        presenter = new GroupDetailPresenter(this, App.getInstance().getComponent().getChatRoomRepository());
